...
const benefits = [
  ...
  {
    icon: Award,
    title: "Niepasteryzowane",
    desc: "Miód wirowany na zimno, wyłącznie z dojrzałych plastrów. Zachowuje wszystkie naturalne enzymy i właściwości zdrowotne.",
  },
  {
    icon: Users,
    ...
    <div className="bg-[#F5EDE4]">
      ...
      <section className="bg-brand-green text-white py-16">
        <div className="max-w-xl mx-auto text-center px-6">
          ...
          <p className="text-white/80 mb-8">W naszej pasiece znajdziesz ponad 8 rodzajów miodów oraz wyjątkowe produkty pszczele.</p>
          <Link href="/produkty">
