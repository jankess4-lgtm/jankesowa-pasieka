  ...
  return (
    <div className="product-card group flex flex-col h-full shadow-md hover:shadow-lg hover:-translate-y-0.5">
      ...
      <div className="flex flex-col flex-1 p-5">
        <div className="mb-auto">
          <Link href={`/produkty/${productSlug}`}>
            <h3 className="font-serif text-xl leading-tight text-brand-brown mb-1.5 hover:text-brand-gold transition-colors">{product.name}</h3>
          </Link>
