...
export const products: Product[] = [
  {
    ...
    description: "Jasnozłoty miód rzepakowo-mniszkowy. Delikatny, bardzo słodki z subtelnymi nutami mniszka. Szybko krystalizuje w kremową konsystencję.",
    longDescription: "Miód rzepakowo-mniszkowy to wyjątkowe połączenie nektaru rzepaku i mniszka lekarskiego. Charakteryzuje się jasnozłotą barwą, bardzo słodkim, delikatnym smakiem z subtelną kwiatową nutą mniszka. Szybko krystalizuje, tworząc drobną, kremową konsystencję. Idealny do herbaty, kanapek, naleśników i dla dzieci. Pochodzi z obfitych pożytków rzepakowych i mniszkowych na kujawskich polach nad Wisłą.",
    price: 60,
    unit: "900 ml (1,2 kg)",
    category: "miody",
  ...
  {
    id: 9,
    name: "Miód akacjowo-spadziowy – 900 ml (1,2 kg)",
    slug: "miod-akacjowo-spadziowy-900ml",
    description: "Harmonijne połączenie kwiatowej delikatności akacji z głębokim, leśnym charakterem spadzi. Rzadki, złożony bukiet.",
    longDescription: "Wyjątkowy miód akacjowo-spadziowy to prawdziwa perła naszej pasieki. Powstaje z połączenia nektaru robinii akacjowej i cennej spadzi leśnej. Delikatna słodycz i subtelny kwiatowy aromat akacji przeplatają się z intensywnym, żywicznym i lekko karmelowym posmakiem spadzi. Pochodzi z unikalnych terenów nadwiślańskich, gdzie akacje sąsiadują z lasami. Rzadki i ceniony przez koneserów.",
    price: 60,
    unit: "900 ml (1,2 kg)",
    category: "miody",
    image: "/images/miod-akacjowy-049-kg.PNG",
